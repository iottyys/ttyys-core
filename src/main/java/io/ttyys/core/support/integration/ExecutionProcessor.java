...
public class ExecutionProcessor {
    ...
    public static final String POINT = "direct:io.ttyys.core.support.integration.routes.StandardExecutionWrapperRouter";
    ...
    @Pointcut("@annotation(io.ttyys.core.support.integration.Execution)")
    private void exec() {}
